...
<script type="text/javascript">
	$(function(){
		...
		//为搜索市场活动模态窗口中的搜索框绑定事件，根据数据的关键字，模糊查询市场活动信息列表
		...
		$("#convertBtn").click(function () {
			...
			/*
				...
				点击转换按钮，不需要在当前convert.jsp中执行任何局部刷新的操作
				所以，发出一个传统请求到后台进行处理即可

				传统请求：
					1.在浏览器地址栏输入地址，敲回车
					2.执行<a href="路径">超链接
					3.执行js window.location.href ="路径"
					4.提交form表单
					...
			...
			if($("#isCreateTransaction").prop("checked")){
				...
				/*
					...
					除了为后台传递clueId之外，还需要传递交易表单中的参数数据

				 */

				//window.location.href ="workbench/clue/convert.do?clueId=xxx&name=xxx&money=xxx&stage=xxx...........";

				/*

					以上做法，不利于将来对交易表单参数的扩展
					所以，我们需要以提交表单的方式，来发出请求，所有的参数，是以post请求头打包的方式为后台传输

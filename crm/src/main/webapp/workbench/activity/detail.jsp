...
<script type="text/javascript">
	...
	function showRemarkList() {
		...
		$.ajax({
			...
			success : function (data) {
				...
				//找到添加操作文本域的div，在该div的上方追加备注信息列表
				$("#remarkDiv").before(html);
		...
		$.ajax({
			...
			success : function (data) {
				...
				if(data.success){
					...
					//以上做法不行，使用before会不断的追加新信息
					//需要找到删除记录所在的div，将这指定的div移除掉
					$("#"+id).remove();
	...
	function editRemark(id) {
		...
		//定位到需要修改的备注信息所在的H5标签对，从标签对中将备注信息取得
		var noteContent = $("#e"+id).html();

		//alert(noteContent);

		//将需要修改的记录的备注信息，填写到修改备注的模态窗口的文本域中
